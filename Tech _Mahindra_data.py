...
with open('b827eb6a07fb_28.txt') as fd:
   data = fd.read().split()
...
df=pd.read_csv('/home/priyanshtripathi10/Documents/output_excel.csv')                       #Put the csv file address here  ie output_file.csv
...
et1.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et1.csv')  


et2=et2[['dateTime','ASmartDG_id','volume']]
et2.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et2.csv') 

et3=et3[['dateTime','ASmartDG_id','DG']]
et3.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et3.csv')

et4=et4[['dateTime','ASmartDG_id','EB']]
et4.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et4.csv')

et5=et5[['dateTime','ASmartDG_id','PT']]
et5.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et5.csv')  

et6=et6[['dateTime','ASmartDG_id','SS']]
et6.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et6.csv')
...
et7.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/et7.csv')
...
et2['Total']=Total_FF
et2.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/customer_et2.csv')
...
df3=pd.read_csv('/home/priyanshtripathi10/Downloads/Tsecond/et3.csv')                               #Loading data from et3.csv
...
df4=pd.read_csv('/home/priyanshtripathi10/Downloads/Tsecond/et4.csv')                              #Loading data from et4.csv            
df4.drop('Unnamed: 0', axis=1, inplace=True)

if df4['EB'][0]==0 and df4['EB'][len(df4)-1]==0:
   DF_obj= DataFrame({'dateTime':[df4['dateTime'][len(df4)-1][0:10]+' 23:55:55'],'ASmartDG_id':[df4['ASmartDG_id'][0]],'EB':[1]})
...
df5=pd.read_csv('/home/priyanshtripathi10/Downloads/Tsecond/et5.csv')                              #Loading data from et4.csv            
...
df6=pd.read_csv('/home/priyanshtripathi10/Downloads/Tsecond/et6.csv')                              #Loading data from et5.csv
...
bigdata6.to_csv('/home/priyanshtripathi10/Downloads/Tsecond/customer_et6.csv')
